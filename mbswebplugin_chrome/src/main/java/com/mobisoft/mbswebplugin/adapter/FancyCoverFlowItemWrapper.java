...
//            Log.i("kkkkk","measuredWidth==="+measuredWidth+",measuredHeight==="+measuredHeight);
            if (this.wrappedViewBitmap == null || this.wrappedViewBitmap.getWidth() != measuredWidth || this.wrappedViewBitmap.getHeight() != measuredHeight) {
                this.wrappedViewBitmap = Bitmap.createBitmap(measuredWidth, measuredHeight, Bitmap.Config.ARGB_8888);// RGB_565 //ARGB_8888
...
//            Log.i("yyyyy","childLeft==="+childLeft+",childRight==="+childRight+",childHeight==="+childHeight);
//            child.layout(childLeft, 0, childRight, childHeight);
//            child.layout(0, 0, measuredWidth, measuredHeight);//全屏
            child.layout(measuredWidth/6, childHeight/3, measuredWidth*5/6, measuredHeight);
        }
    }
