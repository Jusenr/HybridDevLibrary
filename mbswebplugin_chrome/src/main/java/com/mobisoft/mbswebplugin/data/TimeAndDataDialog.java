 ...
 *
 */
public class TimeAndDataDialog extends BaseDialog implements
	...
	public TimeAndDataDialog(Context context) {
...
//					ToastUtil.showLongToast(context, "不能选择当前时间之前的时间");
	...
	public interface OnTimePickListener {
		void onClick(String hour, String minute, int year, int month, int day);
	}
